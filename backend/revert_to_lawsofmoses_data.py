...
async def fetch_and_restore_lawsofmoses_data():
    ...
    try:
        ...
        categories_response = requests.get("https://covenant-app.preview.emergentagent.com/api/categories")
        ...
        mitzvot_response = requests.get("https://covenant-app.preview.emergentagent.com/api/mitzvot")
