...
const MitzvotApp = () => {
  ...
  const [selectedBibleVersion, setSelectedBibleVersion] = useState('yah_scriptures'); // Default to Yah Scriptures for testing
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
                  <div className="lg:col-span-2">
                    <div className="relative">
                      ...
                      <Input
                        placeholder={contentType === 'mitzvot' ? "Search mitzvot, keywords, or verses..." : 
                                   contentType === 'precepts' ? "Search precepts, topics, or verses..." : 
                                   "Search Bible text, books, or verses..."}
                        value={searchTerm}
                  ...
                  <div className="space-y-8">
                    {loading ? (
                      <div className="text-center py-8">
                        <p className="text-gray-500">Loading Bible verses...</p>
                      </div>
                    ) : (bibleVerses || []).length === 0 ? (
                      <div className="text-center py-8">
                        <p className="text-gray-500">No Bible verses found. Try adjusting your filters or version selection.</p>
                      </div>
                    ) : (
